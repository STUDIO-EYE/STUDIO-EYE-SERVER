...
public enum ErrorCode {
	...
	EMPTY_VIEWS(HttpStatus.BAD_REQUEST, "조회수가 존재하지 않습니다."),
	...
	// FAQ
	INVALID_FAQ_ID(HttpStatus.BAD_REQUEST, "유효하지 않은 FAQ 식별자입니다."),
	...
	INVALID_MENU(HttpStatus.BAD_REQUEST, "ALL은 생성할 수 없는 메뉴입니다."),
